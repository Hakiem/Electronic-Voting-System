...
<?php
	...
	$result = mysql_query("SELECT * FROM log WHERE Cat = 'Voter' ORDER BY WhenTaken DESC");
	if(mysql_num_rows($result) > 0)
	{
		echo '<h4>EVENTS LOG FOR VOTERS</h4><br>';
	...
	else
	{
		...
		echo '<h4>THERE ARE NO VOTERS EVENTS TO DISPLAY YET</h4><br>';
		echo '</td></tr></table>';
	}
?>
